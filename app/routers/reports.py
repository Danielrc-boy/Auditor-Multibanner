"""
Generación de reportes descargables (PDF ejecutivo). v1: reusa las
funciones de app/routers/analytics.py directamente (llamadas en Python,
no HTTP interno) para no duplicar ninguna consulta SQL ni lógica de
filtros -- este router solo arma el dict de entrada que espera
...
@router.get("/reports/executive-summary.pdf")
